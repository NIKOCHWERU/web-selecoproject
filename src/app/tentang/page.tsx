...
export const metadata: Metadata = {
  title: 'Tentang Kami | SELECO — Sedana Corporate Consultant',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <p className="text-base text-slate-600 max-w-2xl leading-relaxed font-normal">
              Mengenal lebih dekat visi, standar profesional, dan tim konsultan di balik SELECO (Sedana Corporate Consultant) yang siap mendampingi pertumbuhan bisnis Anda di Indonesia melalui 5 pilar layanan konsultan terpadu.
            </p>
          </div>
        </div>
      </div>
