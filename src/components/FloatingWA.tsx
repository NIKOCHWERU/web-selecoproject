...
export default function FloatingWA() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg group transition-all hover:bg-[#1ebe57]"
