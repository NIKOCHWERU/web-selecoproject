...
export const defaultSiteContent: SiteContent = {
  global: {
    brandName: "SELECO",
    brandTagline: "SEDANA CORPORATE CONSULTANT",
  ...
  footer: {
    description: "SELECO (Sedana Corporate Consultant) adalah konsultan korporasi terpercaya di Indonesia, mengkhususkan diri pada 5 pilar layanan utama: Konsultan Perizinan, Konsultan Imigrasi, Konsultan Pajak, Konsultan Pertanahan, dan Konsultan SDM.",
    copyright: "© 2026 SELECO (Sedana Corporate Consultant). Hak Cipta Dilindungi Undang-Undang.",
  },
  siteMode: {
    status: 'maintenance',
